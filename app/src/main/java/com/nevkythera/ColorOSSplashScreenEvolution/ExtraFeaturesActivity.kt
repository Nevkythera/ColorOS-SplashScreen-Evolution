...
import com.Nevkythera.ColorOSSplashScreenEvolution.ui.screens.ExtraFeaturesPage
...
class ExtraFeaturesActivity : ComponentActivity() {
    ...
    companion object {
        fun start(context: Context) {
            ...
            context.startActivity(
                Intent(context, ExtraFeaturesActivity::class.java).apply {
                    if (needsNewTask) {
